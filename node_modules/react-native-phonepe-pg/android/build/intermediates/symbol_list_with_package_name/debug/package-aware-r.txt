...
color colorButtonBrandFillDisabled
color colorButtonBrandText
color colorButtonBrandTextDisabled
color colorButtonBrandTextFocused
color colorButtonBrandTextPressed
color colorFillDisabled
color colorFillHint
...
color color_green_ic_radio_button_checked
...
color jsonViewer_textColorBool
color jsonViewer_textColorNull
color jsonViewer_textColorNumber
color jsonViewer_textColorString
...
color ph_colorAccent
color ph_colorPrimary
color ph_colorPrimaryDark
color ph_textColor
color ph_textColorAccent
color phone_pe_gradient_end_color
color phone_pe_gradient_start_color
...
dimen default_corner_radius
dimen default_height_min
dimen default_radius_pic_chip_medium
dimen default_space
dimen default_space_Big
dimen default_space_medium_small
dimen default_space_small
dimen dimen_text_button
dimen dimen_text_subheader
...
drawable background_button_brand_round_corner
drawable background_top_border
...
drawable button_brand_text_color
drawable button_brand_text_only_text_color
drawable ic_error_outline
drawable ic_error_outline_black
drawable ic_phonepe_icon
...
drawable solid_circle
drawable test_level_drawable
drawable tooltip_frame_dark
drawable tooltip_frame_light
drawable upi_apps_list_item_stroked_item
...
layout upi_apps_dialog_layout
layout upi_apps_dialog_unit_item
layout v3_debit_response_error
menu example_menu
menu example_menu2
raw loader
...
string intent_sdk_name
string link_description
string load_again
string menu_description
string menubar_description
string menuitem_description
string no_upi_app_found_error
string ok
string pay_via
string pay_with
string ph_merchantLogoUrl
string ph_merchantName
string phonepe_app_package
string phonepe_app_package_preprod
string progress
...
style AppTheme_Overflow
style AppTheme_PopupOverlay
style BasePhonePeTheme
style BasePhonePe_Theme_Base
style BasePhonePe_Theme_Light_NoActionBar
...
style ButtonBrandRoundCorner
style ButtonBrandTextOnly
...
style FadeAnimation
style JsonViewer_TextAppearance
style MyActionBarLogo
style PhonePeTheme
...
style phonepeThemeInvisible
style phonepeThemeInvisibleCompat
style redboxButton
